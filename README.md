...
2. Jika ada berkas watermark (PDF satu halaman, atau gambar PNG/JPG), watermark tersebut ditempel **utuh apa adanya** (tanpa dipotong) dan **selalu di-skalakan agar mengisi (fit) halaman semaksimal mungkin** sambil menjaga rasio aspeknya — sama seperti cara `pdftk` menempelkan watermark ke dokumen. Pendekatan ini sengaja tidak memotong margin kosong di sekitar logo, karena margin tersebut biasanya memang disengaja oleh pembuat watermark agar logo jatuh di posisi yang pas secara visual — kalau dipotong, posisi logo bisa bergeser dari yang seharusnya. Ini berlaku konsisten baik dokumen berukuran A4 maupun A3.
